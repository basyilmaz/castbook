...
<div class="row justify-content-center">
    <div class="col-lg-7 col-xl-6">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h1 class="h4 mb-1">Yeni Vergi Formu</h1>
                <p class="text-muted mb-0">Sisteme yeni bir vergi formu ekleyin.</p>
            </div>
        ...
        <div class="card border-0 shadow-sm">
            <form action="{{ route('settings.tax-forms.store') }}" method="POST">
                @csrf
                <div class="card-body row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  ...
                                  placeholder="Form hakkında kısa açıklama">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="frequency" name="frequency" class="form-select @error('frequency') is-invalid @enderror" required>
                            ...
                            <option value="quarterly" {{ old('frequency') === 'quarterly' ? 'selected' : '' }}>3 Aylık (Çeyrek)</option>
